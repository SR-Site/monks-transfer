 ...
 * {{#crossLink "temple.utils.ui.ElementResizer/resize"}}ElementResizer.resize{{/crossLink}}, or if you just want to
 * get
 ...
 * @param _elementWidth {number} element width/x ratio, e.g. for a 100x200 element you can either pass 100 or 1 as
 *     width
 * @param _elementHeight {number} element height/y ratio, e.g. for a 100x200 element you can either pass 200 or 2 as
 *     height
 ...
 */
export default class ElementResizer extends Disposable {
	/**
	 ...
	 * @param elementWidth {number} element width/x ratio, e.g. for a 100x200 element you can either pass 100 or 1 as
	 *     width
	 * @param elementHeight {number} element height/y ratio, e.g. for a 100x200 element you can either pass 200 or 2 as
	 *     height
	 ...
	 *     height
	 * @param [scaleMode=COVER] {temple.utils.ui.ScaleMode} Scale mode (COVER or RESIZE)
	 * @param [boundsContainer] {IRectangle} Container which it will respect the bounds of. x/y properties can be set
	 *     to
	 ...
	 * @public
	 * @method autoResize
	 * @param duration {number=100} debounce duration in milliseconds
	 */
	public autoResize(duration: number = 100): void {
