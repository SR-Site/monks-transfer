module.exports = function( grunt )
{
	...
	grunt.registerTask( 'create-transition-component', 'Create a transition component (template, viewmodel and controller).', function( n )
	{
		...
		grunt.log.subhead( 'Transition-component creation succesful!' );
		grunt.log.writeln( 'To use your transition-component' );
	} );
	...
	function scaffoldStyleCollectionFile(componentId, subfolder) {
		...
		var filename = grunt.config( 'create-transition-component.options.styleCollectionFilename' );
	...
	function showHelp()
	{
		grunt.log.subhead( 'Usage: grunt create-transition-component --name=[COMPONENT-NAME]' );
	...
	function getConfigDir( name ) {
		return grunt.config( 'create-transition-component.options.directories.' + name );
	}
