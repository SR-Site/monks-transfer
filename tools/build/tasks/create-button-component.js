module.exports = function( grunt )
{
	...
	grunt.registerTask( 'create-button-component', 'Create a button component (template, viewmodel and controller).', function( n )
	{
		...
		grunt.log.subhead( 'button-component creation succesful!' );
		grunt.log.writeln( 'To use your button-component' );
	} );
	...
	function scaffoldStyleCollectionFile(componentId, subfolder) {
		...
		var filename = grunt.config( 'create-button-component.options.styleCollectionFilename' );
	...
	function showHelp()
	{
		grunt.log.subhead( 'Usage: grunt create-button-component --name=[COMPONENT-NAME]' );
	...
	function getConfigDir( name ) {
		return grunt.config( 'create-button-component.options.directories.' + name );
	}
