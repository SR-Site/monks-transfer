...
}(this, function()
{
	...
	function d()
	{
		var e = arguments.length <= 0 || void 0 === arguments[0] ? document : arguments[0], t = [].slice.call(e.querySelectorAll("[data-vimeo-id], [data-vimeo-url]")), n = function(e)
		{
	...
	var w = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : {}, b = (e(function(e, t)
	{
		!function(e)
		{
			function t(e, t)
	...
	}), e(function(e)
	{
		...
		}("Promise", "undefined" != typeof w ? w : w, function()
		{
			...
			var f, l, h, d = Object.prototype.toString, p = "undefined" != typeof setImmediate ? function(e)
			{
	...
	})), E = b && "object" == typeof b && "default" in b ? b.default : b, T = new WeakMap, _ = ["id", "url", "width", "maxwidth", "height", "maxheight", "portrait", "title", "byline", "color", "autoplay", "autopause", "loop", "responsive"], k = function(e, t)
	{
		if(!(e instanceof t))
		{
	...
	}, x = new WeakMap, j = new WeakMap, Player = function()
	{
		function Player(e)
		{
			...
			if(k(this, Player), window.jQuery && e instanceof jQuery && (e.length > 1 && window.console && console.warn && console.warn("A jQuery object with multiple elements was passed, using the first element."), e = e[0]), "string" == typeof e && (e = document.getElementById(e)), !a(e))
			{
			...
			var i = new E(function(r, i)
			{
				var a = function(e)
				{
					if(s(e.origin) && t.element.contentWindow === e.source)
					{
						...
						var n = p(e.data), o = "event" in n && "ready" === n.event, i = "method" in n && "ping" === n.method;
