import TimeUnit from "lib/temple/util/TimeUnit";
...
class DateUtils
{
	 ...
	 */
	private static _TIMEZONES:Array<string> = ['IDLW', 'NT', 'HST', 'AKST', 'PST', 'MST', 'CST', 'EST', 'AST', 'ADT', 'AT', 'WAT', 'GMT', 'CET', 'EET', 'MSK', 'ZP4', 'ZP5', 'ZP6', 'WAST', 'WST', 'JST', 'AEST', 'AEDT', 'NZST'];
	...
	public static parseW3CDTF(value:string):Date
	{
		...
		try
		{
			...
			var secondsArr:Array<string> = (timeArr.length > 0) ? String(timeArr.shift()).split('.') : null;
