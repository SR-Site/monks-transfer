...
import SocketEvent from "lib/temple/net/socket/SocketEvent";
import IResult from "lib/temple/core/IResult";
import MobileDetect from "lib/temple/util/MobileDetect";
...
class SocketService extends EventDispatcher
{
	...
	private getServers()
	{
		...
		}).done((data:{servers:Array<string>; preferred:number; port:number}) =>
		{
