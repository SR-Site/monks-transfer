...
import AssetEvent from "../event/AssetEvent";
...
import IEvent from "../../temple/event/IEvent";
 ...
 * @class PageAsset
 * @extend temple.event.EventDispatcher
 */
class PageAsset extends EventDispatcher implements IPageAsset
{
	...
	private _controller:AbstractPageController<any>;

	public _onProgressDelegate:(event:IEvent, data?:any) => void;
	public _onCompleteDelegate:(event:IEvent, data?:any) => void;
	public _onErrorDelegate:(event:IEvent, data?:any) => void;

	public _onGaiaHistoryDelegate:(event:IEvent, data?:any) => void;
	public _onTransitionCompleteDelegate:(event:IEvent, data?:any) => void;
	public _onTransitionInCompleteDelegate:(event:IEvent, data?:any) => void;
	public _onTransitionOutCompleteDelegate:(event:IEvent, data?:any) => void;
	...
	constructor(node:IPageNode)
	{
		...
		this._log = new Log(`lib.gaia.asset.PageAsset.${StringUtils.camelCase(this.id)}`);
	...
	private onTransitionOutComplete(event:IEvent = null):void
	{
	...
	{
		return this.type == PageType.POPUP;
	}
