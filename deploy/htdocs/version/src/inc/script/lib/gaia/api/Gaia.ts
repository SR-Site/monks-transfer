...
class GaiaImpl implements IGaia
{
	 ...
	 * @method goto
	 * @param {string} branch
	 * @param {HashMap} deeplink [deeplink]
	 * @param {boolean} flow[replace=false]
	 */
	 ...
	 *
	 * @method getRoute
	 * @param {boolean} [includeQueryString=false] determines if querystring is added to the returned route.
	 * @returns {string}
	 */
	public getRoute(includeQueryString:boolean = false):string
	{
		return router.getRoute(includeQueryString);
	}
