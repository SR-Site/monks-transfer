...
class BranchLoader extends EventDispatcher
{
	...
	private loadNext():void
	{
		...
		{
			this._currentAsset._onProgressDelegate = <(event:IEvent) => any>this.onProgress.bind(this);
			this._currentAsset._onCompleteDelegate = <(event:IEvent) => any>this.onComplete.bind(this);
			this._currentAsset._onErrorDelegate = <(event:IEvent) => any>this.onError.bind(this);
