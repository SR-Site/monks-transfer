	...
	describe('gaia', () =>
		describe('router', () =>
			describe('GaiaRouter', () =>
			{
				...
				{
					expect(router.assemble('index/news', {
						filter: 'tag',
						tag: 'tag+name'
					})).toEqual('/news/tag/tag+name');
				});
				it('should assemble index/news/search', () =>
				{
					expect(router.assemble('index/news', {
						filter: 'search',
						query: 'search+query'
					})).toEqual('/news/search/search+query');
				});
				it('should assemble index/news/overview/video/2014-09-12', () =>
				{
					expect(router.assemble('index/news', {
						...
						type: 'video',
						date: '2014-09-12'
					})).toEqual('/news/overview/video/2014-09-12');
				});
				...
				{
					expect(router.assemble('index/recipes', {
						filters: ['filter1', 'filter2'].join('/'),
						page: 0
					})).toEqual('/recipes/filter1/filter2/0');
				});
				it('should assemble index/recipes2 with filters and page', () =>
				{
					expect(router.assemble('index/recipes2', {
						filters: ['filter1', 'filter2'].join('/'),
						page: 0
					})).toEqual('/recipes2/filter1/filter2/0');
				});

				it('should assemble index/mexican-recipes with filters and page', () =>
				{
					expect(router.assemble('index/mexican-recipes', {
						filters: ['filter1', 'filter2'].join('/'),
						page: 0
					})).toEqual('/mexican-recipes/filter1/filter2/0');
				});
				it('should assemble index/mexican-recipes with filters and page', () =>
				{
