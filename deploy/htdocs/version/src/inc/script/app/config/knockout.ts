define([
	...
	'lib/knockout/knockout.icon',
	'lib/knockout/stringTemplateEngine',
	'lib/knockout/knockout.component'
], (ko, punches, gaia, icon) =>
{
	// Call getIcons a single time directly to load the main CSS file for showing background-images
	icon.default.getIcons();
