...
class ButtonPlayCircleController extends AbstractButtonController<ButtonPlayCircleViewModel, IButtonPlayCircleOptions, ButtonPlayCircleTransitionController>
{
	/**
