...
declare namespace mapboxgl
{
	...
	class Map extends Evented
	{
		...
		addSource(id: string, source: any | VectorSource | RasterSource | GeoJSONSource | ImageSource | VideoSource): this;
	...
	{
		id: string;
		type?: "fill" | "line" | "symbol" | "circle" | "raster" | "background" | "fill-extrusion" | "polygon";
		...
		paint?: BackgroundPaint | FillPaint | FillExtrusion | LinePaint | SymbolPaint | RasterPaint | CirclePaint; //TODO: Other types
		//paint.*
	}
