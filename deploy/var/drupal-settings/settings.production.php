...
$settings['flysystem'] = [
  's3' => [
    'driver' => 's3',
    'config' => [
		'key'    => 'AKIAI7226L3NKK3UOA6A',      // 'key' and 'secret' do not need to be
		'secret' => ' 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',   // provided if using IAM roles.
		'region' => 'us-east-1',
		'bucket' => 'spectrum-reach-prod-s3bucket-1nxk6mjng0s0y',
		'cname' => 'spectrum-reach-prod-s3bucket-1nxk6mjng0s0y.s3.amazonaws.com',         // A CNAME that resolves to your bucket. Used for URL generation.
		//'options' => [
		   //'ACL' => 'public-read',
